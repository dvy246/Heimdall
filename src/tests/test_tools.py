...
class TestTechnicalAnalysis:
    ...
    async def test_get_technical_analysis_api_error(self) -> None:
        ...
        try:
            ...
            with patch('src.tools.analysis.technical_analysis.get_stock_data') as mock_get_data:
...
class TestComplianceTools:
    ...
    async def test_compliance_analysis_structured(self) -> None:
        ...
        try:
            from src.tools.analysis.compliance_agent import analyze_compliance_structured
    ...
    def test_compliance_models_validation(self) -> None:
        ...
        try:
            from src.tools.ana.compliance_models import ComplianceReport, ComplianceViolation
